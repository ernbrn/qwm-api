...
RSpec.describe WorksController, type: :controller do
  ...
  describe 'POST #create' do
    context 'with valid params' do
      ...
      it 'renders a JSON response with the new work' do
        post :create, params: { work: valid_attributes }, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(work_url(Work.last))
      end
    end

    context 'with invalid params' do
      it 'renders a JSON response with errors for the new work' do
  ...
  describe 'PUT #update' do
    context 'with valid params' do
      ...
      it 'renders a JSON response with the work' do
        work = Work.create! valid_attributes
    ...
    context 'with invalid params' do
      it 'renders a JSON response with errors for the work' do
        work = Work.create! valid_attributes
